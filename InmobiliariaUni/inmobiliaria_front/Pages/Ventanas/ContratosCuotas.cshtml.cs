...
namespace inmobiliaria_front.Pages.Ventanas
{
    ...
    public class ContratosCuotasModel : PageModel
    {
        ...
        public List<ContratosCuotas>? contratosPendientes { get; set; }
        public List<ContratosCuotas>? contratosAceptados { get; set; }
        public List<ContratosCuotas>? contratosSolicitudes { get; set; }
        public List<ContratosCuotas>? contratosNoAceptados { get; set; }
        ...
        public void OnPostBtAceptarContrato()
        {
            try
            {
                contratosSolicitudes = IContratosCuotasnegocio!.Consultar().Where(c => c.Estado == "Solicitud").ToList();
