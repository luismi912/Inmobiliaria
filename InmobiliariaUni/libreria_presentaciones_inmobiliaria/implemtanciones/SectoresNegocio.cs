...
namespace libreria_presentaciones_inmobiliaria.implemtanciones
{
    public class SectoresNegocio : ISectoresNegocio
    {
        ...
        public List<Sectores> Consultar()
        {
            ...
            datos["Url"] = "https://localhost:7165/Sectores/Consultar";
        ...
        {
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7165/Sectores/Eliminar";
        ...
        public Sectores Guardar(Sectores entidad)
        {
            ...
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7165/Sectores/Guardar";
            datos["Entidad"] = entidad;
        ...
        public Sectores Modificar(Sectores entidad)
        {
            ...
            var datos = new Dictionary<string, object>();
            datos["Url"] = "https://localhost:7165/Sectores/Modificar";
            datos["Entidad"] = entidad;
